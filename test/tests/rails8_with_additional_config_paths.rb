...
class Rails8WithAdditionalConfigPathsTests < Minitest::Test
  include BrakemanTester::FindWarning
  include BrakemanTester::CheckExpected

  def report
    additional_config_path = File.expand_path(File.join(File.dirname(__FILE__), "..", "/apps/rails8_with_additional_config_paths/additional_config/application.rb"))

    @@report ||=
      Date.stub :today, Date.parse("2024-05-13") do
        BrakemanTester.run_scan "rails8_with_additional_config_paths", "Rails 8", run_all_checks: true, use_prism: false, additional_config_paths: [additional_config_path]
      end
  end
