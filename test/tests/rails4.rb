...
class Rails4Tests < Minitest::Test
  ...
  def test_cross_site_scripting_render_inline
    assert_warning :type => :warning,
      :warning_code => 109,
      :fingerprint => "cbc0a2bc55ed94bde53260847a0982d6eb46083e8126bf05be52d69d80e96391",
      :warning_type => "Remote Code Execution",
      :line => 29,
    ...
    assert_warning :type => :warning,
      :warning_code => 109,
      :fingerprint => "22ca54b197f12ad37a3da83132675f3de34c892b335d90ce2d031bce0a84d983",
      :warning_type => "Remote Code Execution",
      :line => 30,
      :message => /^Potential\ remote\ code\ execution\ via\ temp/,
      :confidence => 1,
