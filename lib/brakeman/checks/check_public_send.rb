...
class Brakeman::CheckPublicSend < Brakeman::BaseCheck
  Brakeman::Checks.add self

  @description = "Check for unsafe use of Object#public_send"

  def run_check
    Brakeman.debug("Finding instances of #public_send")
    calls = tracker.find_call :method => :public_send
